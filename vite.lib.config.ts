...
export default defineConfig({
  ...
  // public/ holds the app's libav worker and wasm, which vite copies into whatever outDir it is
  // building. Left on, that puts 21 MB of libav and test media into the published package.
  publicDir: false,
  build: {
    target: 'esnext',
    outDir: 'dist',
